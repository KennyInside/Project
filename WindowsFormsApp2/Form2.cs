...
namespace WindowsFormsApp2
{
    public partial class Form2 : Form
    {
        ...
        {
            if ((TBnameFruit.Text != "") && (TBpriceFruit.Text != "") && (TBcountFruit.Text != ""))
            {
                ...
                try
                {
                    myCommand.CommandText = "INSERT INTO fruits (nameFruit, priceFruit, countFruit) VALUES (" + TBnameFruit.Text + ", " + TBpriceFruit.Text + " , " + TBcountFruit.Text + ")";
